 ...
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST }, description = "Filtro de Seguridad", urlPatterns = { "/restricted/*" }, initParams = { @WebInitParam(name = "LoginParam", value = "/index.xhtml", description = "Pagina de Logueo") })
